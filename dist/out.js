(() => {
  ...
  var Settings = class {
    ...
    save(key, value, apply = true) {
      ...
      this.replace(settings2, false, apply);
    }
    apply() {
      const settings2 = this.getAll();
